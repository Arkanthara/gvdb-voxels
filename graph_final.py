...
plt.plot(df['Seconds_Since_Start'], df['GPU_Memory_Usage(%)'], label='Utilisation Mémoire GPU (%)')
plt.xlabel("Temps (secondes)")
plt.ylabel("Utilisation (%)")
plt.title("Utilisation du CPU, de la Mémoire CPU, du GPU et de la Mémoire GPU")
plt.legend()
plt.grid(True)
plt.show()
